...
requestStoragePermission();
    ...
    private void initUI() {
        ...
        simpleAdapter = new SimpleAdapter(this, transferRecordMaps,
                R.layout.record_item, new String[] {"image","checked", "fileName", "progress", "bytes", "state", "percentage"},
                new int[] {R.id.imguploadprogress,R.id.radioButton1, R.id.textFileName, R.id.progressBar1, R.id.textBytes,
    ...
    private void beginUpload(String filePath) {
        ...
        TransferObserver observer = transferUtility.upload(pref_master.getUserurl()+"/post/images", file.getName(), file, new ObjectMetadata());
