...
public class UserSaveModel {
    ...
    private ArrayList<UserSaveImage> imageModels;
    ...
    public ArrayList<UserSaveImage> getImageModels() {
        return imageModels;
    }

    public void setImageModels(ArrayList<UserSaveImage> imageModels) {
