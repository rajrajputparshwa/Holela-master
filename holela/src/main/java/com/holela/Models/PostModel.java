...
public class PostModel {
    ...
    String postid,userid,posttype,profileiamge,mylike,mySave,postfilename,caption,fullname,username,email,postdatetime,like,comment,share,repost,limit;
    ...
    public String getMySave() {
        return mySave;
    }

    public void setMySave(String mySave) {
        this.mySave = mySave;
    }
