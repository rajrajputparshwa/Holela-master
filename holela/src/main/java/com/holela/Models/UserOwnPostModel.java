...
public class UserOwnPostModel {
    ...
    private ArrayList<UserOwnPostImages> imageModels;
    ...
    public ArrayList<UserOwnPostImages> getImageModels() {
        return imageModels;
    }

    public void setImageModels(ArrayList<UserOwnPostImages> imageModels) {
