...
public class UserOwnLikeAdapter extends BaseAdapter {

    Context context;
    Pref_Master pref_master;
    static int transferdfdf = 0;
    ArrayList<UserOwnLikeModel> own_post_list = new ArrayList<>();
    ...
    public UserOwnLikeAdapter(Context context, ArrayList<UserOwnLikeModel> own_post_list, FragmentManager manager) {
        this.context = context;
        this.own_post_list = own_post_list;
    ...
    public View getView(final int position, View itemView, ViewGroup viewGroup) {
        ...
        final UserOwnLikeModel userOwnLikeModel = own_post_list.get(position);
        LayoutInflater inflater = LayoutInflater.from(context);


        if (itemView == null) {

            itemView = LayoutInflater.from(context).inflate(R.layout.likepostcust, null);
        ...
        String mylike = own_post_list.get(position).getMylike();
        ...
        UserOwnLikeImageAdapter userOwnLikeImageAdapter = new UserOwnLikeImageAdapter(context, singleSectionItems, postid);
        holder.recyclerView.setHasFixedSize(true);
        holder.recyclerView.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false));
        holder.recyclerView.setAdapter(userOwnLikeImageAdapter);
