...
public class UserSaveImageAdapter extends RecyclerView.Adapter<UserSaveImageAdapter.MyView> {

    Context context;
    ArrayList<UserSaveImage> save_image_list = new ArrayList<>();
    String postid;

    public UserSaveImageAdapter(Context context, ArrayList<UserSaveImage> save_image_list, String postid) {
        this.context = context;
        this.save_image_list = save_image_list;
        this.postid = postid;
    }
    ...
    public void onBindViewHolder(final MyView holder, int position) {
        ...
        if (UserSaveAdapter.transfer == 1) {
            ...
            final String img = save_image_list.get(position).getImage();
