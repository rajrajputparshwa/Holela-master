...
public class GetUserStory_Adapter extends RecyclerView.Adapter<GetUserStory_Adapter.MyView> {
    ...
    public GetUserStory_Adapter(Context mContext, ArrayList<GetUserStoryModel> userstory_list) {
                ...
                public void onPrepared(final MediaPlayer mediaPlayer) {
                    ...
                    timer = new CountDownTimer(3000, 3000) {
                        ...
                        public void onFinish() {
                            ...
                            if (mContext instanceof StoryActivity) {
                                ((StoryActivity) mContext).setVideoProgress();
                            }
                        }
                    };
                    timer.start();
