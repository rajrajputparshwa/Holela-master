...
public class OwnPostImageAdapter extends RecyclerView.Adapter<OwnPostImageAdapter.MyView> {
    ...
    public OwnPostImageAdapter(Context context, ArrayList<UserOwnPostImages> post_image_list, String postid) {
    ...
    @Override
    public OwnPostImageAdapter.MyView onCreateViewHolder(ViewGroup parent, int viewType) {
