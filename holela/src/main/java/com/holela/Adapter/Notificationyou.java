...
public class Notificationyou extends BaseAdapter {
    ...
    public Notificationyou(FragmentActivity activity, ArrayList<NotificationModel> array_notify_you_list) {
    ...
    public View getView(final int position, View itemView, ViewGroup viewGroup) {
        ...
        if (itemView == null) {
            itemView = LayoutInflater.from(context).inflate(R.layout.notification_you_layout, null);
           ...
           // holder.post = (ImageView) itemView.findViewById(R.id.noti_post_pic);
            ...
            holder.caption = (TextView) itemView.findViewById(R.id.caption);
        ...
        holder.caption.setText(array_notify_you_list.get(position).getCaption());
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("postid",array_notify_you_list.get(position).getPostid());
                i.putExtra("intent","notification");
