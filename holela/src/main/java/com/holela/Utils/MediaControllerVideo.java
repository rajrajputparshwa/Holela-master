...
import com.holela.Config;
import com.holela.video.InputSurface;
import com.holela.video.MP4Builder;
import com.holela.video.Mp4Movie;
import com.holela.video.OutputSurface;
...
@SuppressLint("NewApi")
public class MediaControllerVideo {

    public static String load,name;
    ...
    private static volatile MediaControllerVideo Instance = null;
    private boolean videoConvertFirstWrite = true;

    public static MediaControllerVideo getInstance() {
        MediaControllerVideo localInstance = Instance;
        if (localInstance == null) {
            synchronized (MediaControllerVideo.class) {
                localInstance = Instance;
                if (localInstance == null) {
                    Instance = localInstance = new MediaControllerVideo();
                }
            }
        }
    ...
    public static class VideoConvertRunnable implements Runnable {
        ...
        @Override
        public void run() {
            MediaControllerVideo.getInstance().convertVideo(videoPath);
        }
    }
    ...
    public boolean convertVideo(final String path) {
        ...
        load= cacheFile.getAbsolutePath();
