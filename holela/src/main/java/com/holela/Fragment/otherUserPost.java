...
import com.holela.Adapter.OtherUserAdapter;
 ...
 */
public class otherUserPost extends Fragment {


    static ListView post;
    Context context;
    static Pref_Master pref_master;
    static OtherUserAdapter ownPostAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_other_user_post, container, false);
        ...
        ownPostAdapter = new OtherUserAdapter(getActivity(), own_post_list, getFragmentManager());
    ...
    public static void getOwnPost(final Context context, final FragmentManager manager, ArrayList<UserOwnPostModel> arrayList) {
        ...
        String url = Config.baseurl + Config.getuserwall + "/" + pref_master.getOtheruserid() + "/" + arrayList.size();
        String json = "";
