...
import com.holela.Adapter.NotificationFollowing;
 ...
 */
public class Notification_Following extends Fragment {


    ListView recyclerView;
    Context context;
    private boolean loading = false;
    NotificationFollowing notificationyou;
    int rr = 0;
...
// handle back button's click listener
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        notificationyou = new NotificationFollowing(getActivity(), array_notify_you_list);
